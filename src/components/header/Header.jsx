      ...
      >
        <div className={styles.container}>
          ...
          <nav className={`${styles.nav} ${isMenuOpen ? styles.open : ""}`}>
            <MenuLink onClick={onCloseMenu} href="/" currentUrl={pathname}>
              Accueil
            </MenuLink>
            <MenuLink
              onClick={onCloseMenu}
            ...
            <MenuLink onClick={onCloseMenu} href="/list" currentUrl={pathname}>
              Nos membres
            </MenuLink>
            <MenuLink onClick={onCloseMenu} href="/about" currentUrl={pathname}>
              A propos
            </MenuLink>
            <MenuLink
              onClick={onCloseMenu}
            ...
            {name ? (
              ...
              <div className={button.mobileMenuButtons}>
                ...
                <Link
                  href="/login"
                  className={button.authButtonSecondary}
                  onClick={onCloseMenu}
                >
                  Se connecter
                </Link>
          ...
          <div className={button.authButtons}>
            {name ? (
              ...
              <>
                ...
                <Link href="/login" className={button.authButtonSecondary}>
                  Se connecter
                </Link>
              </>
            )}
